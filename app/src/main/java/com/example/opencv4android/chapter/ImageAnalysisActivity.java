package com.example.opencv4android.chapter;
...
import com.example.opencv4android.utils.ImageSelectUtils;
...
public class ImageAnalysisActivity extends Activity implements View.OnClickListener {
...
//                    binding.HelloOpenCvView.enableView();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_sobel).setOnClickListener(this);
        findViewById(R.id.btn_scharr).setOnClickListener(this);
        findViewById(R.id.btn_laplacian).setOnClickListener(this);
        findViewById(R.id.btn_canny).setOnClickListener(this);
        findViewById(R.id.btn_houghline).setOnClickListener(this);
        findViewById(R.id.btn_houghlines).setOnClickListener(this);
        findViewById(R.id.btn_houghcircle).setOnClickListener(this);
        findViewById(R.id.btn_findcontours).setOnClickListener(this);
        findViewById(R.id.btn_contourArea).setOnClickListener(this);
        findViewById(R.id.btn_hist).setOnClickListener(this);
        findViewById(R.id.btn_equalizehist).setOnClickListener(this);
        findViewById(R.id.btn_comparehist).setOnClickListener(this);
        findViewById(R.id.btn_backhist).setOnClickListener(this);
        findViewById(R.id.btn_demohist).setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.btn_canny:
                analysisImage(3);
                break;
            case R.id.btn_houghline:
                analysisImage(4);
                break;
            case R.id.btn_houghlines:
                analysisImage(5);
                break;
            case R.id.btn_houghcircle:
                analysisImage(6);
                break;
            case R.id.btn_findcontours:
                analysisImage(7);
                break;
            case R.id.btn_contourArea:
                analysisImage(8);
                break;
            case R.id.btn_hist:
                analysisImage(9);
                break;
            case R.id.btn_equalizehist:
                analysisImage(10);
                break;
            case R.id.btn_comparehist:
                analysisImage(11);
                break;
            case R.id.btn_backhist:
                analysisImage(12);
                break;
            case R.id.btn_demohist:
                analysisImage(13);
                break;
            default:
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CAPTURE_IMAGE && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                Log.d("path", "path=" + f.getAbsolutePath());
